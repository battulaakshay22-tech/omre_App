...
class ShortsShareSheet extends StatelessWidget {
  const ShortsShareSheet({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final shareApps = [
      ...
      {'name': 'Snapchat', 'icon': Icons.camera_alt},
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    Get.snackbar(
                      'Shared',
                      'Successfully shared via ${app['name']}',
